...
namespace RoguelikeV2.Controlers.Entity
{
    ...
    {
        public Interactable(MapPosition position, byte ticks = 0, Guid? id = null, UIElement uIElement = null, Image image = null, string name = null) : base(position, ticks, id, uIElement, image, name)
        {
        }
